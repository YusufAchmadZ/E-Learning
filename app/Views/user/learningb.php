                    ...
                    foreach ($kelasb as $key => $value) { ?>
                        <div class="card mt-1">
                            <div class="card-header" id="headingTwo">
                                <h5 class="mb-0">
                                    <button class="btn collapsed" data-toggle="collapse" data-card-widget="maximize" data-target="#learningb" aria-expanded="false" aria-controls="learningb">
                                        <?= $value['pelajaran']; ?>
                                    </button>
                                </h5>
                            </div>
                            <div id="learningb" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                                <div class="row">
