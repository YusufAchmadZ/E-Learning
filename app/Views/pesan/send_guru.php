            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col-8">
                            <div class="card-header">Pesan Kepada @<?= $admin['nama'] ?></div>
                            <div class="card-body">

                                <form role="form" action="<?= base_url('pesan/tambah_pesan_admin/' . $admin['id']) ?>" method="post">
                                    <div hidden class="form-group">
                                        <input type="text" class="form-control" id="email" name="email" value="<?= $admin['email'] ?>">
                                    </div>
                                    <div hidden class="form-group">
                                        <input type="text" class="form-control" id="kode_guru" name="kode_guru" value="<?= session()->get('kode_guru'); ?>">
                                    </div>
