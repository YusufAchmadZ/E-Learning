            ...
            <div class="modal-body">
                <form role="form" action="<?= base_url('diskusi/tambah_posting'); ?>" method="POST">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <input hidden type="text" class="form-control" name="kode_postingan" id="kode_postingan" value="<?= session()->get('kode_guru') ?>a">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="form-group">
                                <select hidden class="form-control" name="level" id="level">
                                    ...
                                    <?php if (session()->get('kelas') == 8) { ?>
                                        <option value="1"> Kelas 8a </option>
                                    <?php } ?>
                                    <?php if (session()->get('kelas') == 9) { ?>
                                        <option value="1"> Kelas 9a </option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
